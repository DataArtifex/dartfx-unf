...
**This document is a markdown copy of the UNF Version 6 specification document from the [DataVerse Guide](https://guides.dataverse.org/en/latest/developers/unf/unf-v6.html) website.**
...
- [I. UNF of a Data Vector](https://guides.dataverse.org/en/latest/developers/unf/unf-v6.html#i-unf-of-a-data-vector)
- [II. Combining multiple UNFs to create UNFs of higher-level objects.](https://guides.dataverse.org/en/latest/developers/unf/unf-v6.html#ii-combining-multiple-unfs-to-create-unfs-of-higher-level-objects)
- [Footnotes:](https://guides.dataverse.org/en/latest/developers/unf/unf-v6.html#footnotes)

## [I. UNF of a Data Vector](https://guides.dataverse.org/en/latest/developers/unf/unf-v6.html#id1)
...
(See an Important [Note](https://guides.dataverse.org/en/latest/developers/unf/unf-v6.html#note1) on the use of [default and optional](https://guides.dataverse.org/en/latest/developers/unf/unf-v6.html#note1) values and methods!)
...
(see the [Note](https://guides.dataverse.org/en/latest/developers/unf/unf-v6.html#note2) below on [negative zero](https://guides.dataverse.org/en/latest/developers/unf/unf-v6.html#note2))
...
An “official” list of pre-calculated sample UNFs is supplied with the source of the Java implementation of UNF v6; see the [Note](https://guides.dataverse.org/en/latest/developers/unf/unf-v6.html#note4) at the end of the document.
...
(see the [Note](https://guides.dataverse.org/en/latest/developers/unf/unf-v6.html#note3) at the end of this document for a discussion on [potential issues when calculating UNFs of time values](https://guides.dataverse.org/en/latest/developers/unf/unf-v6.html#note3)).
...
## [II. Combining multiple UNFs to create UNFs of higher-level objects.](https://guides.dataverse.org/en/latest/developers/unf/unf-v6.html#id2)
...
## [Footnotes:](https://guides.dataverse.org/en/latest/developers/unf/unf-v6.html#id3)
...
An “official” [list of sample UNFs](https://raw.githubusercontent.com/IQSS/UNF/master/doc/unf_examples.txt) of various data types is provided with the source of the UNF v6 Java implementation.
