...
class TestBitFields:
    ...
    def test_normalize_bit_field_zero(self):
    ...
    def test_binary_column_unf(self):
...
class TestEdgeCases:
    ...
    def test_mixed_type_sensitivity(self):
