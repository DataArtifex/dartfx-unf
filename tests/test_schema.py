...
class TestSchemaFormatBasedParsing:
    ...
    def test_date_format_from_schema_format_property(self, tmp_path):
    ...
    def test_date_multiple_formats_via_oneof(self, tmp_path):
    ...
    def test_datetime_format_from_schema(self, tmp_path):
